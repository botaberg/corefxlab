            ...
            public unsafe static bool TryParseUInt16(byte* text, int length, out short value)
            {
                ...
                else
                {
                    ...
                    for (int index = UInt16OverflowLength - 1; index < length; index++)
                    {
                        ...
                        // if parsedValue == (short.MaxValue / 10), any nextDigit greater than 5 implies overflow.
                        if (parsedValue > short.MaxValue / 10 || (parsedValue == short.MaxValue / 10 && nextDigit > 5))
                        {
                            value = default(short);
                            return false;
                        }
